...
parser.add_argument('--mpc', dest='mpc_ht_uri', help='MPC scores HT', required=True)
...
csq_fields_str = 'Format: ' + '|'.join(csq_columns) + '|LOEUF_v2|LOEUF_v2_decile|LOEUF_v4|LOEUF_v4_decile'
...
csq_fields_str = csq_fields_str + '|OMIM_MIM_number|OMIM_inheritance_code'
